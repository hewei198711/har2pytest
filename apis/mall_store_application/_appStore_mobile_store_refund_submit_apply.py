...
def _appStore_mobile_store_refund_submit_apply(data=data, headers=headers):
    """
    退款申请提交
    /appStore/mobile/store/refund/submit/apply
    ...
    url = "/appStore/mobile/store/refund/submit/apply"
