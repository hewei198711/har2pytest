...
data = {
    ...
    "endMonth": "202604",  # 交易结束月份yyyyMM
    "pageNum": 1,  # 第几页
    "pageSize": 20,  # 每页显示页数
    "startMonth": "202604",  # 交易开始月份yyyyMM
...
def _appStore_store_deposit_details(data=data, headers=headers):
    """
    获取服务中心押货保证金增减明细
    ...
    url = "/appStore/store/deposit/details"
