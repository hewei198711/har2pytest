...
def _appStore_finance_fee_queryFinWalletFeeAmtForOperator(data=data, headers=headers):
    """
    手续费明细统计(运营后台)
    /appStore/finance/fee/queryFinWalletFeeAmtForOperator
    ...
    url = "/appStore/finance/fee/queryFinWalletFeeAmtForOperator"
