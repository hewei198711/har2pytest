...
def _appStore_order_orderSign_getGiftList_2_2(data=data, headers=headers):
    """
    获取电子礼券列表
    /appStore/order/orderSign/getGiftList/2.2
    ...
    url = "/appStore/order/orderSign/getGiftList/2.2"
