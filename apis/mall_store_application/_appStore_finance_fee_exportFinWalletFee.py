...
def _appStore_finance_fee_exportFinWalletFee(data=data, headers=headers):
    """
    店铺系统导出手续费明细表导出(运营后台)
    /appStore/finance/fee/exportFinWalletFee
    ...
    url = "/appStore/finance/fee/exportFinWalletFee"
