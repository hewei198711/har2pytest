...
def _appStore_purchaseExchangeOrder_editReturnInfo(data=data, headers=headers):
    """
    修改退回信息
    /appStore/purchaseExchangeOrder/editReturnInfo
    ...
    url = "/appStore/purchaseExchangeOrder/editReturnInfo"
