...
def _appStore_order_exportOrderProductReport(params=params, headers=headers):
    """
    各产品订单列表导出
    /appStore/order/exportOrderProductReport
    ...
    url = "/appStore/order/exportOrderProductReport"
