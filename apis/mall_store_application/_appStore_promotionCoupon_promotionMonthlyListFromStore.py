...
def _appStore_promotionCoupon_promotionMonthlyListFromStore(params=params, headers=headers):
    """
    分页查询会员活动清单
    /appStore/promotionCoupon/promotionMonthlyListFromStore
    ...
    url = "/appStore/promotionCoupon/promotionMonthlyListFromStore"
