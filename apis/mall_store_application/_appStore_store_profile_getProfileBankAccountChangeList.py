...
def _appStore_store_profile_getProfileBankAccountChangeList(params=params, headers=headers):
    """
    获取服务中心银行账户信息变更列表
    /appStore/store/profile/getProfileBankAccountChangeList
    ...
    url = "/appStore/store/profile/getProfileBankAccountChangeList"
