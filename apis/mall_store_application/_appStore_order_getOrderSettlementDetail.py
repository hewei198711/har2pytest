...
def _appStore_order_getOrderSettlementDetail(params=params, headers=headers):
    """
    交付结算详情
    /appStore/order/getOrderSettlementDetail
    ...
    url = "/appStore/order/getOrderSettlementDetail"
