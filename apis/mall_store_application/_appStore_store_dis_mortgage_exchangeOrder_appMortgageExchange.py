...
def _appStore_store_dis_mortgage_exchangeOrder_appMortgageExchange(data=data, headers=headers):
    """
    APP押货换货下单
    /appStore/store/dis/mortgage/exchangeOrder/appMortgageExchange
    ...
    url = "/appStore/store/dis/mortgage/exchangeOrder/appMortgageExchange"
