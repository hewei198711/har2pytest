...
def _appStore_order_store_factory_addFactoryOrder(data=data, headers=headers):
    """
    新增维修单
    /appStore/order/store/factory/addFactoryOrder
    ...
    url = "/appStore/order/store/factory/addFactoryOrder"
