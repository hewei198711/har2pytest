...
def _appStore_order_getOrderProductStatistics(data=data, headers=headers):
    """
    各系列产品业绩统计表
    /appStore/order/getOrderProductStatistics
    ...
    url = "/appStore/order/getOrderProductStatistics"
