...
def _appStore_finance_voucher_getGiftCouponListForShop(data=data, headers=headers):
    """
    电子礼券列表
    /appStore/finance/voucher/getGiftCouponListForShop
    ...
    url = "/appStore/finance/voucher/getGiftCouponListForShop"
