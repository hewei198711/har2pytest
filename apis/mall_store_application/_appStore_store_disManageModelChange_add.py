...
def _appStore_store_disManageModelChange_add(data=data, headers=headers):
    """
    新增
    /appStore/store/disManageModelChange/add
    ...
    url = "/appStore/store/disManageModelChange/add"
