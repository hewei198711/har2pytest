...
def _appStore_order_orderSign_signToSettlement(data=data, headers=headers):
    """
    签约购去结算
    /appStore/order/orderSign/signToSettlement
    ...
    url = "/appStore/order/orderSign/signToSettlement"
