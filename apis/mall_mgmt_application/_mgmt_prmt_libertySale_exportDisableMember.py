...
def _mgmt_prmt_libertySale_exportDisableMember(params=params, headers=headers):
    """
    导出不可购顾客列表
    /mgmt/prmt/libertySale/exportDisableMember
    ...
    url = "/mgmt/prmt/libertySale/exportDisableMember"
