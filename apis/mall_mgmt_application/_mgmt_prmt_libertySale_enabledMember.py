...
def _mgmt_prmt_libertySale_enabledMember(data=data, headers=headers):
    """
    详情与编辑页/活动详情页 启用-禁用可购会员信息
    /mgmt/prmt/libertySale/enabledMember
    ...
    url = "/mgmt/prmt/libertySale/enabledMember"
