...
def _mgmt_fin_voucher_exportSecondCouponGetDetail(data=data, headers=headers):
    """
    导出秒返券获券明细
    /mgmt/fin/voucher/exportSecondCouponGetDetail
    ...
    url = "/mgmt/fin/voucher/exportSecondCouponGetDetail"
