...
def _mgmt_store_authorization_getAuthorizationLetterList(params=params, headers=headers):
    """
    获取授权书列表
    /mgmt/store/authorization/getAuthorizationLetterList
    ...
    url = "/mgmt/store/authorization/getAuthorizationLetterList"
