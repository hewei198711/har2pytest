...
def _mgmt_cms_questionnaire_editQuestionnaire(data=data, headers=headers):
    """
    编辑问卷
    /mgmt/cms/questionnaire/editQuestionnaire
    ...
    url = "/mgmt/cms/questionnaire/editQuestionnaire"
