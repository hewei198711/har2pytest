...
def _mgmt_order_factory_getFactoryOrderByPage(params=params, headers=headers):
    """
    分页获取返厂维修单
    /mgmt/order/factory/getFactoryOrderByPage
    ...
    url = "/mgmt/order/factory/getFactoryOrderByPage"
