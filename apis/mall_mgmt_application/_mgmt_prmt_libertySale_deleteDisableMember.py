...
def _mgmt_prmt_libertySale_deleteDisableMember(data=data, headers=headers):
    """
    详情与编辑页/活动详情页 删除不可购会员信息
    /mgmt/prmt/libertySale/deleteDisableMember
    ...
    url = "/mgmt/prmt/libertySale/deleteDisableMember"
