...
def _mgmt_fin_voucher_mgmtGrantSecondCouponTotal(data=data, headers=headers):
    """
    已派发金额条数合计
    /mgmt/fin/voucher/mgmtGrantSecondCouponTotal
    ...
    url = "/mgmt/fin/voucher/mgmtGrantSecondCouponTotal"
