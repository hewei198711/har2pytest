...
def _mgmt_orderSign_exportActivityOrderSignList(data=data, headers=headers):
    """
    活动中心 > 签约购活动管理 > 签约购活动详情 > 签约情况列表 > 导出
    /mgmt/orderSign/exportActivityOrderSignList
    ...
    url = "/mgmt/orderSign/exportActivityOrderSignList"
