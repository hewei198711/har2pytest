...
def _mgmt_cms_material_updateCmsMaterialFile(data=data, headers=headers):
    """
    修改素材-文件
    /mgmt/cms/material/updateCmsMaterialFile
    ...
    url = "/mgmt/cms/material/updateCmsMaterialFile"
