...
def _mgmt_dis_inventory_immobility_export_excel(params=params, headers=headers):
    """
    excel导出库存列表(长期不动库存维度)
    /mgmt/dis-inventory/immobility/export-excel
    ...
    url = "/mgmt/dis-inventory/immobility/export-excel"
