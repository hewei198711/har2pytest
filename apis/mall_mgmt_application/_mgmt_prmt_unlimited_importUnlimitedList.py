...
def _mgmt_prmt_unlimited_importUnlimitedList(data=data, headers=headers):
    """
    导入不受限制活动顾客
    /mgmt/prmt/unlimited/importUnlimitedList
    ...
    url = "/mgmt/prmt/unlimited/importUnlimitedList"
