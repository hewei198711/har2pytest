...
def _mgmt_order_return_getUserOrderReturnList(params=params, headers=headers):
    """
    退货单列表
    /mgmt/order/return/getUserOrderReturnList
    ...
    url = "/mgmt/order/return/getUserOrderReturnList"
