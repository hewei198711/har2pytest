...
def _mgmt_dataAdmin_memberRetained_newMemberRetainedList(params=params, headers=headers):
    """
    用户留存数据-新增留存
    /mgmt/dataAdmin/memberRetained/newMemberRetainedList
    ...
    url = "/mgmt/dataAdmin/memberRetained/newMemberRetainedList"
