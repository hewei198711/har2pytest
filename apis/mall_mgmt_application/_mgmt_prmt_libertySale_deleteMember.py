...
def _mgmt_prmt_libertySale_deleteMember(data=data, headers=headers):
    """
    详情与编辑页/活动详情页 删除可购会员信息
    /mgmt/prmt/libertySale/deleteMember
    ...
    url = "/mgmt/prmt/libertySale/deleteMember"
