...
def _mgmt_inventory_mortgageAmount_listMortgageAmountCreditWait2Verify(params=params, headers=headers):
    """
    信誉额查询列表 待审核
    /mgmt/inventory/mortgageAmount/listMortgageAmountCreditWait2Verify
    ...
    url = "/mgmt/inventory/mortgageAmount/listMortgageAmountCreditWait2Verify"
