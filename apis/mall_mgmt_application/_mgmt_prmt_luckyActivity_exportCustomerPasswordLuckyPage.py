...
def _mgmt_prmt_luckyActivity_exportCustomerPasswordLuckyPage(params=params, headers=headers):
    """
    导出口令活动抽奖记录
    /mgmt/prmt/luckyActivity/exportCustomerPasswordLuckyPage
    ...
    url = "/mgmt/prmt/luckyActivity/exportCustomerPasswordLuckyPage"
