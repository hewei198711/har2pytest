...
def _mgmt_prmt_luckyActivity_distinctCustomerLuckyPage(params=params, headers=headers):
    """
    分页查询用户参与情况
    /mgmt/prmt/luckyActivity/distinctCustomerLuckyPage
    ...
    url = "/mgmt/prmt/luckyActivity/distinctCustomerLuckyPage"
