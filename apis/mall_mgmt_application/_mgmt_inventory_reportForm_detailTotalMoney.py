...
def _mgmt_inventory_reportForm_detailTotalMoney(data=data, headers=headers):
    """
    累计已汇押货款余额详情--款项金额总计
    /mgmt/inventory/reportForm/detailTotalMoney
    ...
    url = "/mgmt/inventory/reportForm/detailTotalMoney"
