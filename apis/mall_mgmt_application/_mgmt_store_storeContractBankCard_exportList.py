...
def _mgmt_store_storeContractBankCard_exportList(params=params, headers=headers):
    """
    导出列表
    /mgmt/store/storeContractBankCard/exportList
    ...
    url = "/mgmt/store/storeContractBankCard/exportList"
