...
def _mgmt_order_return_countWaitReturnInvoice(params=params, headers=headers):
    """
    统计待审核退票单
    /mgmt/order/return/countWaitReturnInvoice
    ...
    url = "/mgmt/order/return/countWaitReturnInvoice"
