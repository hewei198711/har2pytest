...
def _mgmt_prmt_luckyActivity_shareAssistExport(params=params, headers=headers):
    """
    shareAssistExport
    /mgmt/prmt/luckyActivity/shareAssistExport
    ...
    url = "/mgmt/prmt/luckyActivity/shareAssistExport"
