...
def _mgmt_dataAdmin_CouponBoard_getCouponBoardMemberDetailList(data=data, headers=headers):
    """
    获取优惠券看板派发明细列表
    /mgmt/dataAdmin/CouponBoard/getCouponBoardMemberDetailList
    ...
    url = "/mgmt/dataAdmin/CouponBoard/getCouponBoardMemberDetailList"
