...
def _mgmt_inventory_disManageModelChange_edit(data=data, headers=headers):
    """
    编辑
    /mgmt/inventory/disManageModelChange/edit
    ...
    url = "/mgmt/inventory/disManageModelChange/edit"
