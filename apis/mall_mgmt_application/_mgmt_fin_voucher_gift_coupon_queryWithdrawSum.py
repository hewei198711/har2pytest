...
def _mgmt_fin_voucher_gift_coupon_queryWithdrawSum(data=data, headers=headers):
    """
    电子礼券提现列表总计
    /mgmt/fin/voucher/gift/coupon/queryWithdrawSum
    ...
    url = "/mgmt/fin/voucher/gift/coupon/queryWithdrawSum"
