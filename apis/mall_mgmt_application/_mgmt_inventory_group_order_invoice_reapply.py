...
def _mgmt_inventory_group_order_invoice_reapply(data=data, headers=headers):
    """
    团购单申请重开发票
    /mgmt/inventory/group-order/invoice/reapply
    ...
    url = "/mgmt/inventory/group-order/invoice/reapply"
