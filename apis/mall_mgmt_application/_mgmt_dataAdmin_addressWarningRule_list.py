...
def _mgmt_dataAdmin_addressWarningRule_list(params=params, headers=headers):
    """
    获取预警规则列表
    /mgmt/dataAdmin/addressWarningRule/list
    ...
    url = "/mgmt/dataAdmin/addressWarningRule/list"
