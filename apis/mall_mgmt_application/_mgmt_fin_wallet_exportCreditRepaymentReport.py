...
def _mgmt_fin_wallet_exportCreditRepaymentReport(data=data, headers=headers):
    """
    信用额还款情况报表
    /mgmt/fin/wallet/exportCreditRepaymentReport
    ...
    url = "/mgmt/fin/wallet/exportCreditRepaymentReport"
