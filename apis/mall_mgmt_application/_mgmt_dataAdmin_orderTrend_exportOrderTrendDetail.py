...
def _mgmt_dataAdmin_orderTrend_exportOrderTrendDetail(data=data, headers=headers):
    """
    导出订单数据走势-明细数据
    /mgmt/dataAdmin/orderTrend/exportOrderTrendDetail
    ...
    url = "/mgmt/dataAdmin/orderTrend/exportOrderTrendDetail"
