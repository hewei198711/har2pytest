...
def _mgmt_prmt_luckyActivity_editPrizeConfigHandType(data=data, headers=headers):
    """
    活动奖品-奖品配置-奖品派发数量编辑
    /mgmt/prmt/luckyActivity/editPrizeConfigHandType
    ...
    url = "/mgmt/prmt/luckyActivity/editPrizeConfigHandType"
