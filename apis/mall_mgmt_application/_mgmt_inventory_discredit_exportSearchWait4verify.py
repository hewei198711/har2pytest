...
def _mgmt_inventory_discredit_exportSearchWait4verify(params=params, headers=headers):
    """
    待审核信誉额搜索列表导出
    /mgmt/inventory/discredit/exportSearchWait4verify
    ...
    url = "/mgmt/inventory/discredit/exportSearchWait4verify"
