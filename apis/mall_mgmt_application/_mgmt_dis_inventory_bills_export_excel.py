...
def _mgmt_dis_inventory_bills_export_excel(params=params, headers=headers):
    """
    excel导出库存对账单
    /mgmt/dis-inventory/bills/export-excel
    ...
    url = "/mgmt/dis-inventory/bills/export-excel"
