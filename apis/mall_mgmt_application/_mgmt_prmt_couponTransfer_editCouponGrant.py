...
def _mgmt_prmt_couponTransfer_editCouponGrant(data=data, headers=headers):
    """
    编辑优惠券派发记录
    /mgmt/prmt/couponTransfer/editCouponGrant
    ...
    url = "/mgmt/prmt/couponTransfer/editCouponGrant"
