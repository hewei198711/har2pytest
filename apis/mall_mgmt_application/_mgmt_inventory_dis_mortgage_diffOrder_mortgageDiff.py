...
def _mgmt_inventory_dis_mortgage_diffOrder_mortgageDiff(data=data, headers=headers):
    """
    下单
    /mgmt/inventory/dis/mortgage/diffOrder/mortgageDiff
    ...
    url = "/mgmt/inventory/dis/mortgage/diffOrder/mortgageDiff"
