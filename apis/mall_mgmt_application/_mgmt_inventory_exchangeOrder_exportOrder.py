...
params = {
    ...
    "orderStatus": 0,  # 1待审核 2待退回 3待验货 4待补换 5待收货 6已完成 7已取消
    "pageNum": 0,  # 页数
    "pageSize": 0,  # 页大小
    "productDisposalType": 0,  # 旧品处理方式 1服务中心报废 2分公司报废 3退货中转仓
...
def _mgmt_inventory_exchangeOrder_exportOrder(params=params, headers=headers):
    """
    下载中心导出押货换货单
    /mgmt/inventory/exchangeOrder/exportOrder
    ...
    - orderStatus: 1待审核 2待退回 3待验货 4待补换 5待收货 6已完成 7已取消
    - pageNum: 页数
    - pageSize: 页大小
    ...
    url = "/mgmt/inventory/exchangeOrder/exportOrder"
