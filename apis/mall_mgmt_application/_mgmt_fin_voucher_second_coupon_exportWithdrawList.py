...
def _mgmt_fin_voucher_second_coupon_exportWithdrawList(data=data, headers=headers):
    """
    导出秒返券提现列表
    /mgmt/fin/voucher/second/coupon/exportWithdrawList
    ...
    url = "/mgmt/fin/voucher/second/coupon/exportWithdrawList"
