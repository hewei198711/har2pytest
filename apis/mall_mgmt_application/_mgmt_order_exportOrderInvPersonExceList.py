...
def _mgmt_order_exportOrderInvPersonExceList(data=data, headers=headers):
    """
    导出异常个人要票订单列表
    /mgmt/order/exportOrderInvPersonExceList
    ...
    url = "/mgmt/order/exportOrderInvPersonExceList"
