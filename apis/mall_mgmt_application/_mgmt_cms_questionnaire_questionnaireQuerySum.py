...
def _mgmt_cms_questionnaire_questionnaireQuerySum(data=data, headers=headers):
    """
    问卷回收数据查询统计
    /mgmt/cms/questionnaire/questionnaireQuerySum
    ...
    url = "/mgmt/cms/questionnaire/questionnaireQuerySum"
