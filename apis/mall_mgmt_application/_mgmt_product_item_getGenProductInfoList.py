...
def _mgmt_product_item_getGenProductInfoList(data=data, headers=headers):
    """
    搜索基本产品列表
    /mgmt/product/item/getGenProductInfoList
    ...
    url = "/mgmt/product/item/getGenProductInfoList"
