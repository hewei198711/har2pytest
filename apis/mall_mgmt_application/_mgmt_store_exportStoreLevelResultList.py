...
def _mgmt_store_exportStoreLevelResultList(params=params, headers=headers):
    """
    网点等级标志列表导出
    /mgmt/store/exportStoreLevelResultList
    ...
    url = "/mgmt/store/exportStoreLevelResultList"
