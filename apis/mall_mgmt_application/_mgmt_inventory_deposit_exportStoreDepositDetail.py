...
def _mgmt_inventory_deposit_exportStoreDepositDetail(params=params, headers=headers):
    """
    85折账款管理 -- 服务中心押货保证详情导出
    /mgmt/inventory/deposit/exportStoreDepositDetail
    ...
    url = "/mgmt/inventory/deposit/exportStoreDepositDetail"
