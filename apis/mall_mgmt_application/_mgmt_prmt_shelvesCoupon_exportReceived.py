...
def _mgmt_prmt_shelvesCoupon_exportReceived(params=params, headers=headers):
    """
    导出领取列表
    /mgmt/prmt/shelvesCoupon/exportReceived
    ...
    url = "/mgmt/prmt/shelvesCoupon/exportReceived"
