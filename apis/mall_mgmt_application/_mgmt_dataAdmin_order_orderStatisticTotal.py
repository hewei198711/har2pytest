...
def _mgmt_dataAdmin_order_orderStatisticTotal(params=params, headers=headers):
    """
    订单统计总数
    /mgmt/dataAdmin/order/orderStatisticTotal
    ...
    url = "/mgmt/dataAdmin/order/orderStatisticTotal"
