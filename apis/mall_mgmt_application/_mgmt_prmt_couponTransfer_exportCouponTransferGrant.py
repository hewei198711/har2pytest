...
def _mgmt_prmt_couponTransfer_exportCouponTransferGrant(params=params, headers=headers):
    """
    导出转赠优惠券派发列表
    /mgmt/prmt/couponTransfer/exportCouponTransferGrant
    ...
    url = "/mgmt/prmt/couponTransfer/exportCouponTransferGrant"
