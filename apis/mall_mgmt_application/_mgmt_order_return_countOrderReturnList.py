...
def _mgmt_order_return_countOrderReturnList(params=params, headers=headers):
    """
    订单退货列表统计
    /mgmt/order/return/countOrderReturnList
    ...
    url = "/mgmt/order/return/countOrderReturnList"
