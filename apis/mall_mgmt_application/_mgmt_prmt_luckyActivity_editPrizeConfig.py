...
def _mgmt_prmt_luckyActivity_editPrizeConfig(data=data, headers=headers):
    """
    活动奖品编辑
    /mgmt/prmt/luckyActivity/editPrizeConfig
    ...
    url = "/mgmt/prmt/luckyActivity/editPrizeConfig"
