...
def _mgmt_inventory_mortgageAmount_exportSearchMortgageAmountList(data=data, headers=headers):
    """
    服务中心账款管理 -- 押货余额列表导出
    /mgmt/inventory/mortgageAmount/exportSearchMortgageAmountList
