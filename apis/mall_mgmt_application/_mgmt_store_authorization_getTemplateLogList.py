...
def _mgmt_store_authorization_getTemplateLogList(params=params, headers=headers):
    """
    获取授权书模板日志列表
    /mgmt/store/authorization/getTemplateLogList
    ...
    url = "/mgmt/store/authorization/getTemplateLogList"
