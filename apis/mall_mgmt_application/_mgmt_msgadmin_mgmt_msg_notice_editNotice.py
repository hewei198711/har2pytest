...
def _mgmt_msgadmin_mgmt_msg_notice_editNotice(data=data, headers=headers):
    """
    编辑公告
    /mgmt/msgadmin/mgmt/msg/notice/editNotice
    ...
    url = "/mgmt/msgadmin/mgmt/msg/notice/editNotice"
