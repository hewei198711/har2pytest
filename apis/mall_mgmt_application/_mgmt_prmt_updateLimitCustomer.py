...
data = {
    "id": 0,  # 活动id
    "limitCustomer": 0,  # 参与顾客设置:1-所有 2-自定义顾客群 4-导入
    "memberCustom": {
        "cardEndDate": "",
        "cardStartDate": "",
        "cardStatuses": [],
...
def _mgmt_prmt_updateLimitCustomer(data=data, headers=headers):
    """
    切换参与活动顾客规则
    /mgmt/prmt/updateLimitCustomer

    参数说明:
    - id: 活动id
    - limitCustomer: 参与顾客设置:1-所有 2-自定义顾客群 4-导入
    - memberCustom: 自定义顾客群
    ...
    url = "/mgmt/prmt/updateLimitCustomer"
