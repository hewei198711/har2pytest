...
def _mgmt_prmt_giftPromotion_exportGiftInfo(params=params, headers=headers):
    """
    导出赠品领用详情列表
    /mgmt/prmt/giftPromotion/exportGiftInfo
    ...
    url = "/mgmt/prmt/giftPromotion/exportGiftInfo"
