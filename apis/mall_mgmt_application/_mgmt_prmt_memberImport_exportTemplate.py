...
def _mgmt_prmt_memberImport_exportTemplate(params=params, headers=headers):
    """
    下载模板
    /mgmt/prmt/memberImport/exportTemplate
    ...
    url = "/mgmt/prmt/memberImport/exportTemplate"
