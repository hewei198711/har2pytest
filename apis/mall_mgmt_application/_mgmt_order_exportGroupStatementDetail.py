...
def _mgmt_order_exportGroupStatementDetail(params=params, headers=headers):
    """
    单位团购对账单详情批量导出
    /mgmt/order/exportGroupStatementDetail
    ...
    url = "/mgmt/order/exportGroupStatementDetail"
