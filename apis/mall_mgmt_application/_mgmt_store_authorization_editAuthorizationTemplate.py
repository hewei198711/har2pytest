...
def _mgmt_store_authorization_editAuthorizationTemplate(data=data, headers=headers):
    """
    修改授权书模板
    /mgmt/store/authorization/editAuthorizationTemplate
    ...
    url = "/mgmt/store/authorization/editAuthorizationTemplate"
