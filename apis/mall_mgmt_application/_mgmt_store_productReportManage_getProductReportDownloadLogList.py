...
def _mgmt_store_productReportManage_getProductReportDownloadLogList(params=params, headers=headers):
    """
    获取成品报告下载日志列表
    /mgmt/store/productReportManage/getProductReportDownloadLogList
    ...
    url = "/mgmt/store/productReportManage/getProductReportDownloadLogList"
