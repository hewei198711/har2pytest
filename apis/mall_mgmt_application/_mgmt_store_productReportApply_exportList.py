...
def _mgmt_store_productReportApply_exportList(params=params, headers=headers):
    """
    运营后台:成品报告审批导出Excel
    /mgmt/store/productReportApply/exportList
    ...
    url = "/mgmt/store/productReportApply/exportList"
