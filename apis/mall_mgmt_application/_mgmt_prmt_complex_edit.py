...
data = {
    ...
    "chooseProducts": [{"quantity": 0, "serialNo": "", "stage": 0, "type": 0}],  # 可选商品集合
    "clause": "",  # 活动条款
    "commitment": "",  # 代购承诺书
    ...
    "freedomGrantCoupons": [
        {"couponId": 0, "couponNumber": "", "giveStage": "", "quantity": 0, "step": 0, "type": 0}
    ],  # 下单-自由商品赠送优惠券集合
    "freedomRenewedGrantCoupons": [
        {"couponId": 0, "couponNumber": "", "giveStage": "", "quantity": 0, "step": 0, "type": 0}
    ],  # 续签-自由商品赠送优惠券集合
    "grantCoupon": False,  # 是否赠送优惠券 false-否 true-是
    "id": 0,  # 活动主键
    "importKey": "",  # 导入操作键
    "introMobile": "",  # 移动端活动介绍
    "introPc": "",  # PC端活动介绍
    "limitCustomer": 0,  # 参与顾客设置:1-所有顾客,2-自定义顾客群,4-自由导入
    "linkSignSalePlus": [{"promotionId": 0}],  # 续签关联的签约购3.0活动信息
    ...
    "mustProducts": [{"quantity": 0, "serialNo": "", "stage": 0, "type": 0}],  # 必选商品集合
    "poster": "",  # 活动分享海报
    "productComplexType": 0,  # 活动产品组合类型:0-固定产品,1-自由组合产品,2-自由组合+固定产品
    "promotionCode": "",  # 活动编号
    ...
    "recommends": [
        {
            "chooseProducts": [{"quantity": 0, "serialNo": "", "stage": 0, "type": 0}],
            "cover": "",
            "mustProducts": [{"quantity": 0, "serialNo": "", "stage": 0, "type": 0}],
            "name": "",
        }
    ],  # 推荐组合信息
    "remark": "",  # 活动说明
    ...
    "sureProducts": [{"quantity": 0, "serialNo": "", "stage": 0, "type": 0}],  # 固定商品集合
    "sureRenewedGrantCoupons": [
        {"couponId": 0, "couponNumber": "", "giveStage": "", "quantity": 0, "step": 0, "type": 0}
    ],  # 续签-固定商品赠送优惠券集合
...
def _mgmt_prmt_complex_edit(data=data, headers=headers):
    """
    编辑签约购活动
    /mgmt/prmt/complex/edit

    参数说明:
    - changeAddrLimit: 修改活动地址次数限制
    - changeableAddr: 是否支持修改活动地址：true-支持,false-不支持
    - chooseProducts: 可选商品集合
    - chooseProducts.quantity: 每期最大购买数量 / 每期购买数量 / 每期推荐数量
    - chooseProducts.serialNo: 产品编码
    - chooseProducts.stage: 活动期数(固定商品字段)
    - chooseProducts.type: 类型:1-必选商品,2-可选商品,3-固定商品
    - clause: 活动条款
    - commitment: 代购承诺书
    ...
    - coverPc: PC端活动封面图
    - endTime: 结束时间
    - freedomGiftProducts: 自由商品赠品集合
    - freedomGiftProducts.customPrice: 画线价
    - freedomGiftProducts.giveStage: 赠送期数
    - freedomGiftProducts.quantity: 赠送数量
    - freedomGiftProducts.serialNo: 赠品产品编码
    - freedomGiftProducts.step: 赠品所属阶梯档位(固定商品无阶梯)
    - freedomGiftProducts.type: 赠品对应的组合类型:0-固定组合赠品,1-自由组合赠品
    - freedomGrantCoupons: 下单-自由商品赠送优惠券集合
    - freedomGrantCoupons.couponId: 优惠券id
    - freedomGrantCoupons.couponNumber: 优惠券编号
    - freedomGrantCoupons.giveStage: 赠送期数
    - freedomGrantCoupons.quantity: 赠送数量
    - freedomGrantCoupons.step: 赠送优惠券所属阶梯档位(固定商品无阶梯)
    - freedomGrantCoupons.type: 优惠券对应的组合类型:0-固定组合赠券,1-自由组合赠券
    - freedomRenewedGrantCoupons: 续签-自由商品赠送优惠券集合
    - freedomRenewedGrantCoupons.couponId: 优惠券id
    - freedomRenewedGrantCoupons.couponNumber: 优惠券编号
    - freedomRenewedGrantCoupons.giveStage: 赠送期数
    - freedomRenewedGrantCoupons.quantity: 赠送数量
    - freedomRenewedGrantCoupons.step: 赠送优惠券所属阶梯档位(固定商品无阶梯)
    - freedomRenewedGrantCoupons.type: 优惠券对应的组合类型:0-固定组合赠券,1-自由组合赠券
    - grantCoupon: 是否赠送优惠券 false-否 true-是
    - id: 活动主键
    - importKey: 导入操作键
    - introMobile: 移动端活动介绍
    - introPc: PC端活动介绍
    - limitCustomer: 参与顾客设置:1-所有顾客,2-自定义顾客群,4-自由导入
    - linkSignSalePlus: 续签关联的签约购3.0活动信息
    - linkSignSalePlus.promotionId: 签约购3.0活动Id
    - loopEndTime: 最后循坏启动时间
    - memberCustom: 自定义顾客群
    ...
    - mustProducts: 必选商品集合
    - mustProducts.quantity: 每期最大购买数量 / 每期购买数量 / 每期推荐数量
    - mustProducts.serialNo: 产品编码
    - mustProducts.stage: 活动期数(固定商品字段)
    - mustProducts.type: 类型:1-必选商品,2-可选商品,3-固定商品
    - poster: 活动分享海报
    - productComplexType: 活动产品组合类型:0-固定产品,1-自由组合产品,2-自由组合+固定产品
    - promotionCode: 活动编号
    ...
    - recommends.chooseProducts.quantity: 每期最大购买数量 / 每期购买数量 / 每期推荐数量
    - recommends.chooseProducts.serialNo: 产品编码
    - recommends.chooseProducts.stage: 活动期数(固定商品字段)
    - recommends.chooseProducts.type: 类型:1-必选商品,2-可选商品,3-固定商品
    - recommends.cover: 组合图地址
    - recommends.mustProducts: 必选商品集合
    - recommends.mustProducts.quantity: 每期最大购买数量 / 每期购买数量 / 每期推荐数量
    - recommends.mustProducts.serialNo: 产品编码
    - recommends.mustProducts.stage: 活动期数(固定商品字段)
    - recommends.mustProducts.type: 类型:1-必选商品,2-可选商品,3-固定商品
    ...
    - steps.step: 阶梯档位
    - sureGiftProducts: 固定商品赠品集合
    - sureGiftProducts.customPrice: 画线价
    - sureGiftProducts.giveStage: 赠送期数
    - sureGiftProducts.quantity: 赠送数量
    - sureGiftProducts.serialNo: 赠品产品编码
    - sureGiftProducts.step: 赠品所属阶梯档位(固定商品无阶梯)
    - sureGiftProducts.type: 赠品对应的组合类型:0-固定组合赠品,1-自由组合赠品
    - sureGrantCoupons: 下单-固定商品赠送优惠券集合
    - sureGrantCoupons.couponId: 优惠券id
    - sureGrantCoupons.couponNumber: 优惠券编号
    - sureGrantCoupons.giveStage: 赠送期数
    - sureGrantCoupons.quantity: 赠送数量
    - sureGrantCoupons.step: 赠送优惠券所属阶梯档位(固定商品无阶梯)
    - sureGrantCoupons.type: 优惠券对应的组合类型:0-固定组合赠券,1-自由组合赠券
    - sureProducts: 固定商品集合
    - sureProducts.quantity: 每期最大购买数量 / 每期购买数量 / 每期推荐数量
    - sureProducts.serialNo: 产品编码
    - sureProducts.stage: 活动期数(固定商品字段)
    - sureProducts.type: 类型:1-必选商品,2-可选商品,3-固定商品
    - sureRenewedGrantCoupons: 续签-固定商品赠送优惠券集合
    - sureRenewedGrantCoupons.couponId: 优惠券id
    - sureRenewedGrantCoupons.couponNumber: 优惠券编号
    - sureRenewedGrantCoupons.giveStage: 赠送期数
    - sureRenewedGrantCoupons.quantity: 赠送数量
    - sureRenewedGrantCoupons.step: 赠送优惠券所属阶梯档位(固定商品无阶梯)
    - sureRenewedGrantCoupons.type: 优惠券对应的组合类型:0-固定组合赠券,1-自由组合赠券
    - totalPrice: 产品合计价
    - totalStages: 活动总期数
    - upgrade: 是否允许签约购升级 false-否 true-是
    """

    url = "/mgmt/prmt/complex/edit"
