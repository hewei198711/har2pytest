...
def _mgmt_inventory_discredit_countCreditAmount(data=data, headers=headers):
    """
    信誉额统计及服务中心总数获取
    /mgmt/inventory/discredit/countCreditAmount
    ...
    url = "/mgmt/inventory/discredit/countCreditAmount"
