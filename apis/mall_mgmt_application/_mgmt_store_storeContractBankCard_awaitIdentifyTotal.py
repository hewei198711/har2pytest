...
def _mgmt_store_storeContractBankCard_awaitIdentifyTotal(data=data, headers=headers):
    """
    待识别数量
    /mgmt/store/storeContractBankCard/awaitIdentifyTotal
    ...
    url = "/mgmt/store/storeContractBankCard/awaitIdentifyTotal"
