...
def _mgmt_fin_wallet_credit_stages_querySumCreditStagesData(data=data, headers=headers):
    """
    信用分期管理搜索（统计）
    /mgmt/fin/wallet/credit/stages/querySumCreditStagesData
    ...
    url = "/mgmt/fin/wallet/credit/stages/querySumCreditStagesData"
