...
def _mgmt_prmt_state_luckyActivity(params=params, headers=headers):
    """
    抽奖活动管理各状态数量
    /mgmt/prmt/state/luckyActivity
    ...
    url = "/mgmt/prmt/state/luckyActivity"
