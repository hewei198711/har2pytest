...
def _mgmt_inventory_discredit_wait4verifyOrDetail(data=data, headers=headers):
    """
    待审核信誉额分页列表/详情分页列表
    /mgmt/inventory/discredit/wait4verifyOrDetail
    ...
    url = "/mgmt/inventory/discredit/wait4verifyOrDetail"
