...
def _mgmt_prmt_luckyActivity_customerLuckyPage(params=params, headers=headers):
    """
    分页查询用户抽奖情况
    /mgmt/prmt/luckyActivity/customerLuckyPage
    ...
    url = "/mgmt/prmt/luckyActivity/customerLuckyPage"
