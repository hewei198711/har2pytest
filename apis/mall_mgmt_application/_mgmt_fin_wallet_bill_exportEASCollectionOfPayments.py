...
def _mgmt_fin_wallet_bill_exportEASCollectionOfPayments(data=data, headers=headers):
    """
    商城系统导出EAS收款凭证(商城后台)
    /mgmt/fin/wallet/bill/exportEASCollectionOfPayments
    ...
    url = "/mgmt/fin/wallet/bill/exportEASCollectionOfPayments"
