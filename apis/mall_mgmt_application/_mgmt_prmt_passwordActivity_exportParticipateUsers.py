...
def _mgmt_prmt_passwordActivity_exportParticipateUsers(data=data, headers=headers):
    """
    导出口令活动参与用户列表
    /mgmt/prmt/passwordActivity/exportParticipateUsers
    ...
    url = "/mgmt/prmt/passwordActivity/exportParticipateUsers"
