...
def _mgmt_cms_advert_editAdvertPage_advertId(params=params, headers=headers):
    """
    编辑广告页
    /mgmt/cms/advert/editAdvertPage/{advertId}
    ...
    url = f"/mgmt/cms/advert/editAdvertPage/{params['advertId']}"
