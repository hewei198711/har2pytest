...
def _mgmt_dataAdmin_export_shopWarningDetail(data=data, headers=headers):
    """
    购货预警列表导出
    /mgmt/dataAdmin/export/shopWarningDetail
    """

    url = "/mgmt/dataAdmin/export/shopWarningDetail"
