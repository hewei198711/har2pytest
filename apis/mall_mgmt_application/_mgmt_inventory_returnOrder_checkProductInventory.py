...
def _mgmt_inventory_returnOrder_checkProductInventory(data=data, headers=headers):
    """
    店铺库存校验接口
    /mgmt/inventory/returnOrder/checkProductInventory
    ...
    url = "/mgmt/inventory/returnOrder/checkProductInventory"
