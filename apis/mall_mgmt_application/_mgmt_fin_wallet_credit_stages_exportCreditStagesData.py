...
def _mgmt_fin_wallet_credit_stages_exportCreditStagesData(data=data, headers=headers):
    """
    信用额分期导出
    /mgmt/fin/wallet/credit/stages/exportCreditStagesData
    ...
    url = "/mgmt/fin/wallet/credit/stages/exportCreditStagesData"
