...
def _mgmt_fin_wallet_credit_updateAdjustBatchDetail(data=data, headers=headers):
    """
    信用额调整批次详情-修改
    /mgmt/fin/wallet/credit/updateAdjustBatchDetail
    ...
    url = "/mgmt/fin/wallet/credit/updateAdjustBatchDetail"
