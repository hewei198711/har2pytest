...
def _mgmt_prmt_unlimited_getUnlimitedUserList(params=params, headers=headers):
    """
    不限制活动顾客导出
    /mgmt/prmt/unlimited/getUnlimitedUserList
    ...
    url = "/mgmt/prmt/unlimited/getUnlimitedUserList"
