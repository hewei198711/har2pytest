...
def _mgmt_prmt_couponGrant_exportCouponGrantList(params=params, headers=headers):
    """
    导出优惠券派发列表
    /mgmt/prmt/couponGrant/exportCouponGrantList
    ...
    url = "/mgmt/prmt/couponGrant/exportCouponGrantList"
