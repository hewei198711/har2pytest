...
def _mgmt_prmt_shoppedGift_exportByHandler(params=params, headers=headers):
    """
    导出经办人获券列表
    /mgmt/prmt/shoppedGift/exportByHandler
    ...
    url = "/mgmt/prmt/shoppedGift/exportByHandler"
