...
def _mgmt_dataAdmin_msym_storeStatisticsList(data=data, headers=headers):
    """
    查询交付门店统计明细
    /mgmt/dataAdmin/msym/storeStatisticsList
    ...
    url = "/mgmt/dataAdmin/msym/storeStatisticsList"
