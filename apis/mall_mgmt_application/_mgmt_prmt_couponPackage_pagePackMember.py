...
def _mgmt_prmt_couponPackage_pagePackMember(params=params, headers=headers):
    """
    优惠券券包优惠券详情分页查询
    /mgmt/prmt/couponPackage/pagePackMember
    ...
    url = "/mgmt/prmt/couponPackage/pagePackMember"
