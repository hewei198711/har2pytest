...
def _mgmt_inventory_return_config_exportList(params=params, headers=headers):
    """
    退货额度搜索列表导出Excel
    /mgmt/inventory/return/config/exportList
    ...
    url = "/mgmt/inventory/return/config/exportList"
