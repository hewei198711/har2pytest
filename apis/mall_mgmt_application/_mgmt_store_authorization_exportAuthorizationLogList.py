...
def _mgmt_store_authorization_exportAuthorizationLogList(params=params, headers=headers):
    """
    导出授权书日志列表
    /mgmt/store/authorization/exportAuthorizationLogList
    ...
    url = "/mgmt/store/authorization/exportAuthorizationLogList"
