...
def _mgmt_inventory_disInventoryQuota_pageList(data=data, headers=headers):
    """
    分页列表
    /mgmt/inventory/disInventoryQuota/pageList
    ...
    url = "/mgmt/inventory/disInventoryQuota/pageList"
