...
def _mgmt_fin_voucher_getSecondCouponPendingSum(data=data, headers=headers):
    """
    顾客查询-秒返券待生效合计
    /mgmt/fin/voucher/getSecondCouponPendingSum
    ...
    url = "/mgmt/fin/voucher/getSecondCouponPendingSum"
