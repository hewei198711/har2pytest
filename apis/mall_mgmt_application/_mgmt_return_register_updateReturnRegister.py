...
def _mgmt_return_register_updateReturnRegister(data=data, headers=headers):
    """
    修改登记退货信息
    /mgmt/return/register/updateReturnRegister
    ...
    url = "/mgmt/return/register/updateReturnRegister"
