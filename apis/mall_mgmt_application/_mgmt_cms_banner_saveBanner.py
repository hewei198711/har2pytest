...
data = {
    ...
    "projectKey": "",  # 问卷key
    "relateType": 0,  # 关联类型,1:关联产品; 2:关联活动,3:商城内部链接,4:跳转其他小程序,5:外部链接,6:问卷,7:抽奖活动,8:签约购活动2.0,9:随心购活动,10:随心购活动列表,11:签约购活动3.0,12:专区页面,13:签约购活动落地页,14.S+S+S活动,15:签约购4.0,16.送礼活动
    "shelfConfig": 0,  # 上下架配置,1:立即上架; 2:定时上架;3:定时上下架
    "shelfOffTime": 0,  # banner下架时间
    "shelfStatus": 0,  # 上架状态,0：待上架; 1：已上架；2：已下架
    "shelfUpTime": 0,  # banner上架时间
    "sort": 0,  # 排序
    "targetValue": "",  # 关联的内容值
...
def _mgmt_cms_banner_saveBanner(data=data, headers=headers):
    """
    新增Banner
    /mgmt/cms/banner/saveBanner
