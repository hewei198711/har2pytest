...
def _mgmt_fin_wallet_exportInvoiceSheetApplyList(data=data, headers=headers):
    """
    计算表.导出申请记录列表
    /mgmt/fin/wallet/exportInvoiceSheetApplyList
    ...
    url = "/mgmt/fin/wallet/exportInvoiceSheetApplyList"
