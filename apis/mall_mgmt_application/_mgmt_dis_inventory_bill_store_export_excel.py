...
def _mgmt_dis_inventory_bill_store_export_excel(params=params, headers=headers):
    """
    导出库存历史列表（按服务中心维度）
    /mgmt/dis-inventory/bill/store/export-excel
    ...
    url = "/mgmt/dis-inventory/bill/store/export-excel"
