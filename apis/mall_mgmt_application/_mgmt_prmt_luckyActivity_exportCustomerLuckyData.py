...
def _mgmt_prmt_luckyActivity_exportCustomerLuckyData(params=params, headers=headers):
    """
    导出用户抽奖情况数据
    /mgmt/prmt/luckyActivity/exportCustomerLuckyData
    ...
    url = "/mgmt/prmt/luckyActivity/exportCustomerLuckyData"
