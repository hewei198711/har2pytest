...
def _mgmt_fin_wallet_credit_exportAuditBatchDetail(data=data, headers=headers):
    """
    云商信用额录入批次详情审核列表批量导出
    /mgmt/fin/wallet/credit/exportAuditBatchDetail
    ...
    url = "/mgmt/fin/wallet/credit/exportAuditBatchDetail"
