...
def _mgmt_cms_questionnaire_editQuestionnaireLite(data=data, headers=headers):
    """
    编辑问卷lite
    /mgmt/cms/questionnaire/editQuestionnaireLite
    ...
    url = "/mgmt/cms/questionnaire/editQuestionnaireLite"
