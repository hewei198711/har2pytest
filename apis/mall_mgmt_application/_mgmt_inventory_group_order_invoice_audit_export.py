...
def _mgmt_inventory_group_order_invoice_audit_export(params=params, headers=headers):
    """
    发票审核列表导出
    /mgmt/inventory/group-order/invoice/audit/export
    ...
    url = "/mgmt/inventory/group-order/invoice/audit/export"
