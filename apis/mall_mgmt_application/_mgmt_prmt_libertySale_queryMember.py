...
def _mgmt_prmt_libertySale_queryMember(data=data, headers=headers):
    """
    详情与编辑页/活动详情页 查询可购会员信息
    /mgmt/prmt/libertySale/queryMember
    ...
    url = "/mgmt/prmt/libertySale/queryMember"
