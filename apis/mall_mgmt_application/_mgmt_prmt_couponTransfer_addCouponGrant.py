...
def _mgmt_prmt_couponTransfer_addCouponGrant(data=data, headers=headers):
    """
    新增优惠券派发记录
    /mgmt/prmt/couponTransfer/addCouponGrant
    ...
    url = "/mgmt/prmt/couponTransfer/addCouponGrant"
