...
def _mgmt_fin_wallet_queryControlCashierConfig(data=data, headers=headers):
    """
    查询受控/管控列表
    /mgmt/fin/wallet/queryControlCashierConfig
    ...
    url = "/mgmt/fin/wallet/queryControlCashierConfig"
