...
def _mgmt_order_damage_exportCargoDamageList(params=params, headers=headers):
    """
    货损货差导出
    /mgmt/order/damage/exportCargoDamageList
    ...
    url = "/mgmt/order/damage/exportCargoDamageList"
