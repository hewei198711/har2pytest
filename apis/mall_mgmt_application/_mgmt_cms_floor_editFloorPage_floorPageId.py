...
def _mgmt_cms_floor_editFloorPage_floorPageId(params=params, headers=headers):
    """
    编辑楼层页
    /mgmt/cms/floor/editFloorPage/{floorPageId}
    ...
    url = f"/mgmt/cms/floor/editFloorPage/{params['floorPageId']}"
