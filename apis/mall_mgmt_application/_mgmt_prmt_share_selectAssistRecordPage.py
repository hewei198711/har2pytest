...
def _mgmt_prmt_share_selectAssistRecordPage(params=params, headers=headers):
    """
    分页查询助力记录
    /mgmt/prmt/share/selectAssistRecordPage
    ...
    url = "/mgmt/prmt/share/selectAssistRecordPage"
