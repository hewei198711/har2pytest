...
def _mgmt_prmt_luckyActivity_customerPasswordLuckyPage(params=params, headers=headers):
    """
    分页查询口令活动-抽奖活动 抽奖记录
    /mgmt/prmt/luckyActivity/customerPasswordLuckyPage
    ...
    url = "/mgmt/prmt/luckyActivity/customerPasswordLuckyPage"
