...
def _mgmt_prmt_combine_exportDisableMember(params=params, headers=headers):
    """
    导出不可购顾客列表
    /mgmt/prmt/combine/exportDisableMember
    ...
    url = "/mgmt/prmt/combine/exportDisableMember"
