...
def test_extract_params_from_swagger():
    ...
    body_params_only = [{"name": "dto", "in": "body", "schema": {"$ref": "#/definitions/UserDto"}}]
    swagger_data_with_def = {
        "definitions": {"UserDto": {"properties": {"username": {"type": "string"}, "age": {"type": "integer"}}}}
    }
...
def test_extract_body_params():
    ...
    # 测试内联模型
    inline_schema = {"properties": {"name": {"type": "string"}, "count": {"type": "integer"}}}
    ...
    swagger_data_empty = {"definitions": {"EmptyDto": {}}}
