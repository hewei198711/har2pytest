...
def test_mgmt_prmt_luckyActivity_luckyActivityList(test_headers):
    ...
    def step_mgmt_prmt_luckyActivity_luckyActivityList():
        ...
        with _mgmt_prmt_luckyActivity_luckyActivityList(params=params, headers=test_headers) as r:
    ...
    def step_mgmt_prmt_state_luckyActivity():
        ...
        with _mgmt_prmt_state_luckyActivity(params=params, headers=test_headers) as r:
            assert r.status_code == 200
            assert r.json()["code"] == 200
    ...
    def step_mgmt_prmt_state_waitExamineCount():
        ...
        with _mgmt_prmt_state_waitExamineCount(headers=test_headers) as r:
            assert r.status_code == 200
            assert r.json()["code"] == 200
