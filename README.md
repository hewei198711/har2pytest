...
class APIGenerator:
    ...
    def escape_string_for_python(self, value: str) -> str:
        # 转义字符串以便在Python代码中使用

    def sanitize_filename(self, filename: str) -> str:
        # 清理文件名，移除不合法字符

    def extract_function_name(self, url: str) -> str:
        # 从URL提取函数名，优先匹配PATH_URLS中的路径参数模式
        # 示例: '/mobile/msg/manage/letter/dashbord/12345' -> '_mobile_msg_manage_letter_dashbord_usrId'
        # 示例: '/mobile/order/carts/getRecommendProduct/ABC123' -> '_mobile_order_carts_getRecommendProduct_serialNo'
...
- 自定义文档解析：继承 `SwaggerDocUpdater` 类
